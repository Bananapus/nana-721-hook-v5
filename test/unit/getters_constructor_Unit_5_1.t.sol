...
contract Test_Getters_Constructor_Unit_5_1 is UnitTestSetup {
    ...
    function test_tiersOf_returnsAllTiers(uint256 numberOfTiers) public {
        ...
        ForTest_JB721TiersHook5_1 hook = _initializeForTestHook5_1(numberOfTiers);
        ...
        public
    {
        ...
        JB721TiersHook5_1 hook = JB721TiersHook5_1(address(jbHookDeployer5_1.deployHookFor(projectId, hookConfig, salt)));
    ...
    function test_numberOfPendingReservesFor_returnsPendingReserves() public {
        ...
        ForTest_JB721TiersHook5_1 hook = _initializeForTestHook5_1(10);
