...
contract Test_adjustTier_Unit_5_1 is UnitTestSetup {
        ...
        public
    {
        ...
        JB721TiersHook5_1 hook = _initHookDefaultTiers5_1(initialNumberOfTiers);
        ...
        tiersLeft = _addDeleteTiers5_1(hook, tiersLeft, 2, tierConfigs);

        // Remove another 2 tiers but don't add any new ones.
        _addDeleteTiers5_1(hook, tiersLeft, 2, new JB721TierConfig[](0));
        ...
        public
    {
        ...
        currentNumberOfTiers = _addDeleteTiers5_1(hook, currentNumberOfTiers, 0, tierConfigsToAdd);
        currentNumberOfTiers = _addDeleteTiers5_1(hook, currentNumberOfTiers, 2, tierConfigsToAdd);
        ...
        public
    {
        ...
        tiersLeft = _addDeleteTiers5_1(hook, tiersLeft, 0, tierConfigs);
        ...
        public
    {
        ...
        tiersLeft = _addDeleteTiers5_1(hook, tiersLeft, 0, tierConfigsToAdd);
        ...
        public
    {
        ...
        _addDeleteTiers5_1(hook, tiersLeft, 0, tierConfigs);
        ...
        public
    {
        ...
        // Add the new tiers.
        _addDeleteTiers5_1(hook, 0, 0, tierConfigsToAdd);
        ...
        public
    {
        ...
        ForTest_JB721TiersHook5_1 hook = new ForTest_JB721TiersHook5_1(
            projectId,
    ...
    function test_adjustTiers_addAndRemoveTiers() public {
        ...
        JB721TiersHook5_1 hook = JB721TiersHook5_1(hook_i);
        hook.initialize(
            projectId,
            name,
            symbol,
        ...
        public
    {
        ...
        ForTest_JB721TiersHook5_1 hook = _initializeForTestHook5_1(initialNumberOfTiers);
    ...
    function test_tiersOf_emptyArrayIfNoInitializedTiers(uint256 size) public {
        ...
        JB721TiersHook5_1 hook = _initHookDefaultTiers5_1(0);
