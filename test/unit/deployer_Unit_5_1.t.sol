...
import "../../src/interfaces/IJB721TiersHookProjectDeployer5_1.sol";
import "../../src/structs/JBLaunchProjectConfig.sol";
import "../../src/structs/JB721InitTiersConfig.sol";

import "../utils/UnitTestSetup.sol";

contract Test_ProjectDeployer_Unit_5_1 is UnitTestSetup {
    using stdStorage for StdStorage;

    IJB721TiersHookProjectDeployer5_1 deployer;

    function setUp() public override {
        super.setUp();

        deployer = new JB721TiersHookProjectDeployer5_1(
            IJBDirectory(mockJBDirectory), IJBPermissions(mockJBPermissions), jbHookDeployer5_1, address(0)
        );
    }
