...
import {JB721TiersHookDeployer5_1} from "../src/JB721TiersHookDeployer5_1.sol";
import {JB721TiersHookProjectDeployer5_1} from "../src/JB721TiersHookProjectDeployer5_1.sol";
import {JB721TiersHookStore} from "../src/JB721TiersHookStore.sol";
import {JB721TiersHook5_1} from "../src/JB721TiersHook5_1.sol";
...
contract DeployScript is Script, Sphinx {
    ...
    bytes32 HOOK_SALT = "JB721TiersHook5_1_";
    bytes32 HOOK_DEPLOYER_SALT = "JB721TiersHookDeployer5_1_";
    bytes32 HOOK_STORE_SALT = "JB721TiersHookStore_";
    bytes32 PROJECT_DEPLOYER_SALT = "JB721TiersHookProjectDeployer5_1_";
    ...
    function deploy() public sphinx {
        ...
        JB721TiersHook5_1 hook;
        {
            ...
            (address _hook, bool _hookIsDeployed) = _isDeployed(
                HOOK_SALT,
                type(JB721TiersHook5_1).creationCode,
                abi.encode(core.directory, core.permissions, store, TRUSTED_FORWARDER)
            );
